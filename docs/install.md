...
version (7.5.8). This can be helpful if there is a requirement to tag and
...
dashboard through a LoadBalancer, Ingress or OpenShift Route you can
use the instructions here.
### Using Veeam Kasten Console Plugin
...
application state.
### Enable Veeam Kasten Console Plugin
...
Enabled checkbox.
### Veeam Kasten Console Plugin UI Overview
