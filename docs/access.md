...
- K10-Config-View Binding
Default Veeam Kasten ClusterRoles
### Default Veeam Kasten ClusterRolesï
...
### Token-Based Authentication with AWS EKSï
...
Debugging Login Issues
- Debugging Login Issues
### Obtaining Tokens with Red Hat OpenShiftï
...
following command:
### OAuth Proxy with Red Hat OpenShift (Preview)ï
...
### Forwarding Traffic to the Proxyï
...
### Sample Auth Flow with Screenshotsï
...
documentation here.
### OpenID Connect Authenticationï
...
### Veeam Kasten Setupï
### Provider Redirect URI Authorizationsï
...
Manual Root CA Certificates Extraction
section.
### Install or Update Veeam Kasten with OpenShift Authenticationï
...
### Manual Root CA Certificates Extractionï
...
### Manual OAuth Client Configurationï
### Manual Client Service Account Creationï
...
### Manual Client Secret Creationï
...
### Active Directory Authenticationï
...
## Veeam Kasten Dashboard Directly From the Google Cloud Consoleï
- Dashboard Access
Access via kubectl
Veeam Kasten Dashboard Directly From the Google Cloud Console
Accessing via a LoadBalancer
...
## Enabling AWS IAM Token-Based Auth for EKSï
- Dashboard Access
- API and Command Line
- Authentication
Direct Access
...
tools are available.
### Creating IAM Policies and Rolesï
...
following command.
Export the value as AWS_IAM_ROLE_ARN:
### Installing and Configuring Veeam Kastenï
Note
...
### Logging into the Veeam Kasten Dashboard using AWS IAM Tokensï
