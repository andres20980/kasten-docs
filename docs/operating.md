...
```
% curl https://docs.kasten.io/downloads/8.0.10/tools/k10_primer.sh | bash /dev/stdin blockmount -s ${STORAGE_CLASS_NAME}
```
...
```
$ curl -s https://docs.kasten.io/downloads/8.0.10/tools/k10_debug.sh | bash;
```
...
```
$ curl -s https://docs.kasten.io/downloads/8.0.10/tools/k10_debug.sh | \    bash -s -- -n <k10-namespace> -o <logfile-name>;
```
...
```
$ curl -s https://docs.kasten.io/downloads/8.0.10/tools/k10_debug.sh | \    bash -s -- --prom-duration 4h30m --prom-start-time "-2 days -3 hours"
```
